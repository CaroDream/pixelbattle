...
export async function POST(request: NextRequest) {
  try {
    ...
    // Use the origin of the current request so preview deployments return to the same preview,
    // rather than redirecting a test purchase to the production domain.
